<img src="https://github.com/xls69/re3-unix/blob/miami/res/images/logo_1024.png?raw=true" alt="re3 logo" width="200">
...
![screen_ 1613087332](https://github.com/xls69/re3-unix/blob/miami/res/images/reVC_1.png)
![screen_ 1613086852](https://github.com/xls69/re3-unix/blob/miami/res/images/reVC_2.png)
![screen_ 1613086989](https://github.com/xls69/re3-unix/blob/miami/res/images/reVC_3.png)
![screen_ 1613087193](https://github.com/xls69/re3-unix/blob/miami/res/images/reVC_4.png)
...
Clone the repository with `git clone --recursive -b miami https://github.com/xls69/re3-unix.git reVC-unix`. Then `cd reVC-unix` into the cloned repository.
...
> :information_source: There are various settings in [config.h](https://github.com/xls69/re3-unix/tree/miami/src/core/config.h), you may want to take a look there.
...
We have a [Coding Style](https://github.com/xls69/re3-unix/blob/miami/CODING_STYLE.md) document that isn't followed or enforced very well.
